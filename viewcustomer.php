...
<?php if(($_REQUEST['suc'])==1) echo "<h1>Deleted Successfully</h1>"?>
 <table class="col-xs-10 table-bordered table-striped table-condensed cf">
      ...
      <th scope="col">ACCOUNT <br /> STATUS</th>
      <th scope="col">LOCATION</th>
      <th scope="col">ACCOPEN DATE</th>
...
echo " <tr>
	 ...
	 ?>
	  ...
	  <tr>
      <th colspan="6" scope="col" align="center"><a href="customer.php">   <input type="submit" id="submit" value="Add Customers" class="btn btn-primary" />
</a></th>
    </tr>
    </table>
