...
<form id="form1" name="form1" method="post" action="makeloanpayment2.php" onsubmit="return validateForm()">
              ...
              <h3><b> &nbsp; Pay loan</b></h3><br><br>


<div class="form-group">
              <label class="col-md-3 control-label" for="email">Loan Account Number</label>
              <div class="col-md-4">
...
<br>
<div class="form-group">
              <label class="col-md-3 control-label" for="email">Enter the amount:</label>
              <div class="col-md-4">
