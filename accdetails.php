...
<div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
    ...
    <ul class="nav nav-pills nav-stacked" style="border-right:1px solid black">
        ...
        <li class="active"><a href="accdetails.php">> View Account Balance</a></li>
...
<br><br><p><b> &nbsp; &nbsp; &nbsp; ACCOUNT DETAILS :</b></p><br>
...
<div class="container">
 ...
 <table class="col-xs-10 table-bordered table-striped table-condensed cf" align="center">
            ...
            <tr>
                 <th colspan="2" scope="col"><p align="center"><?php echo $_SESSION[customername] ?></p></th></tr>
                 <tr><th scope="col">Account Number</th> <td><?php echo $acno; ?></td></tr>
                 <tr><th scope="col">Account Type</th> <td><?php echo $acctype ; ?></td></tr>
                 <tr><th scope="col">Account Status</th> <td><?php echo $status ; ?></td></tr>
                 <tr><th scope="col">Account Holder</th> <td><?php echo $_SESSION[customername] ?></td></tr>
                
                 <tr><th scope="col">Account Open Date</th> <td><?php echo $accopen ; ?></td></tr>
                 <tr><th scope="col">Account Balance</th> <td><?php echo $accbal ; ?></td></tr>
