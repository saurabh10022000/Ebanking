	 ...
	 ?>  
   	  ...
   	  <form onsubmit="return valid()" id="form1" name="form1" method="post" action="">
   	  	...
   	  	<div class="form-group">
              ...
              <div class="col-md-4">
                <input type="text" name="empname" onKeyPress="return isNumberKey(event)" id="empname" class="form-control" >
...
<div class="form-group">
              ...
              <div class="col-md-4">
            <input type="text" name="contno2" id="contno2" class="form-control"></td>
...
<div class="form-group">
              ...
              <div class="col-md-4">
                <input type="text" name="emid" id="emid" class="form-control">
        	       
              </div>
            </div>

<br><br>
   	          &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <input type="submit" name="button2" id="button2" value="ADD" class="btn btn-primary" />
