...
<h2><b>&nbsp; &nbsp; BRANCH DETAILS</b></h2><br><br>
...
echo " <tr>
	  ...
	  ?>
	  <tr>
      <th colspan="6" scope="col" align="center"><a href="addbranch.php">                       <input type="submit" name="ADD BRANCH" id="submit" value="Add Branch" class="btn btn-primary" />
</a></th>
    </tr>
  </table>